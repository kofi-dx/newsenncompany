...
export default function ManagerDashboard() {
  ...
  const getEmployeeInitials = (employee: Employee): string => {
    ...
    return 'EE'; // Default initials for "Employee"
  };
    ...
    try {
      ...
      const employeesData: Employee[] = employeesSnapshot.docs.map(doc => {
        ...
        return {
          id: doc.id,
          ...data,
          // Ensure we have proper name handling
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Total Contributors</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Content engagement</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Contributor payouts</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-800">Team Employees</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Articles waiting review</p>
            </div>
          ...
          <div className="space-y-4">
            ...
            {topContributors.length === 0 && (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Earnings will appear when contributors start publishing</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            {recentEmployees.length === 0 && (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm">Add employees to start building your team</p>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="text-lg font-semibold text-green-700">Add Employee</div>
            <div className="text-sm text-green-600 mt-1">Create new team member</div>
          </Link>
          ...
          >
            <div className="text-lg font-semibold text-blue-700">Manage Contributors</div>
            <div className="text-sm text-blue-600 mt-1">View and manage contributors</div>
          </Link>
          ...
          >
            <div className="text-lg font-semibold text-purple-700">Review Articles</div>
            <div className="text-sm text-purple-600 mt-1">{stats.pendingApprovals} pending</div>
          </Link>
          ...
          >
            <div className="text-lg font-semibold text-orange-700">View Analytics</div>
            <div className="text-sm text-orange-600 mt-1">Performance reports</div>
          </Link>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          {recentArticles.length === 0 && (
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">Articles will appear here when contributors start publishing</p>
            </div>
          )}
        </div>
      </div>
